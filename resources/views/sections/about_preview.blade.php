        ...
        <div class="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div class="order-2 lg:order-1" data-reveal>
                ...
                <div class="mt-10 flex flex-col gap-4 sm:flex-row">
                    ...
                    @endif
                    <a href="{{ route('products.index') }}" wire:navigate class="inline-flex items-center justify-center rounded-full border border-black/10 px-8 py-3 text-sm font-semibold text-text-primary transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-champagne">Lihat katalog</a>
                </div>
            </div>
                ...
                @else
                    <div class="grid min-h-[520px] place-items-center bg-[radial-gradient(circle_at_top,_rgba(183,154,99,0.2),_transparent_42%),linear-gradient(180deg,_#171717_0%,_#0B0B0B_100%)] p-10 text-center">
                        <div class="max-w-md">
                            ...
                            <p class="mt-5 text-2xl font-semibold leading-tight text-white">Visual about section siap menampung foto lifestyle atau studio.</p>
                            <p class="mt-4 text-sm leading-7 text-white/60">Satu gambar kuat cukup, biar brand terasa premium tanpa jadi padat.</p>
                        </div>
                    </div>
                @endif
            </div>
