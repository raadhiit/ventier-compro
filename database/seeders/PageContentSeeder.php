    ...
    public function run(): void
    {
        $sections = [
            ...
            [
                ...
                'section_key' => 'story',
                'title' => 'Cerita Kami',
                'content' => '<p>Ventier lahir dari keprihatinan terhadap kualitas produk interior kendaraan yang beredar di pasaran. Kami percaya bahwa setiap perjalanan layak dinikmati dengan kenyamanan maksimal.</p><p>Berawal dari tahun 2020, Ventier mulai merancang dan memproduksi berbagai aksesoris interior mobil dengan fokus pada kualitas bahan, presisi desain, dan kepuasan pelanggan.</p>',
                'is_visible' => true,
                'sort_order' => 1,
            ],
            [
            ...
            [
                ...
                'subtitle' => 'Jelajahi katalog produk Ventier dan temukan yang sesuai untuk kendaraan Anda.',
